    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            form_mail = (
                ...
                .filter(
                    id=GET_VALUE_ACTION_SYSTEM("SET_ID_FORM_PAYMENT_REQUEST"),
                    active=True,
                    is_used=True,
                )
                .first()
            ...
            for mail in mails:
                if mail:
                    ...
                    parts_dict = {
                        ...
                        "link": f"<a href='{parts[3]}'>Link truy cập!</a>",
            ...
            for p in list_person:
                ...
                if GET_VALUE_ACTION_SYSTEM("SET_ID_FORM_PAYMENT_REQUEST") in ["4"]:
                ...
                try:
                    data_as_bytes = base64.b64decode(p["image_string"].split(",")[1])
                    # Nếu mail form thuộc 4 - QR CODE BỆNH VIỆN + STK
                    if GET_VALUE_ACTION_SYSTEM("SET_ID_FORM_PAYMENT_REQUEST") in ["4"]:
                        data_as_bytes_qr_bv = base64.b64decode(
                            GET_VALUE_ACTION_SYSTEM(
                                "SET_QR_BV_BASE64_FOR_SEND_MAIL_PAYMENT_REQUEST"
                            ).split(",")[1]
                        )
                        outlook.send(
                            ...
                            body_images={
                                ...
                                "qr_tai_khoan": data_as_bytes_qr_bv,
                            },
                        )
                    # Không QR + STK
                    else:
                        outlook.send(
                            ...
                            html=content_form,
                            attachments={},
                            body_images={"my_image": data_as_bytes},
                        )
