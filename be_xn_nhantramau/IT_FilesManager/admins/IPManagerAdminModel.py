...
# ================= IPManager ================= #
class IPManagerAdminForm(forms.ModelForm):
    class Meta:
        model = IPManager
        fields = "__all__"
...
class IPManagerAdmin(ConfirmActionAdmin):
    form = IPManagerAdminForm
    ...
    def get_list_display(self, request):
        fields = [field.name for field in IPManager._meta.get_fields()]
