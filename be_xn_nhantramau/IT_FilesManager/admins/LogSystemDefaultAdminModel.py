...
# ================= LogEntryApp ================= #
class LogEntryAppAdminForm(forms.ModelForm):
    class Meta:
        model = LogEntryApp
        fields = "__all__"
...
class LogEntryAppAdmin(ConfirmActionAdmin):
    form = LogEntryAppAdminForm
    ...
    def get_list_display(self, request):
        fields = [field.name for field in LogEntryApp._meta.get_fields()]
