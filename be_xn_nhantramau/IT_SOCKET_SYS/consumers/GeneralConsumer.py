...
class GeneralConsumerBase(BaseConsumer):
    """
    ...
    """
    URL_PATH = r"ws/general/(?P<module>[\w\d]+)/"
    ...
    async def connect(self):
        ...
        self.module = self.scope["url_route"]["kwargs"]["module"]
        self.group_name = f"notify_general_{self.module}"
