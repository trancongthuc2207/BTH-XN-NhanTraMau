...
# ================= LogEntrySys ================= #
class LogEntrySysAdminForm(forms.ModelForm):
    class Meta:
        model = LogEntrySys
        fields = "__all__"
...
class LogEntrySysAdmin(ConfirmActionAdmin):
    form = LogEntrySysAdminForm
    ...
    def get_list_display(self, request):
        fields = [field.name for field in LogEntrySys._meta.get_fields()]
